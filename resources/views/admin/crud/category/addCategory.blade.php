...
@section('content')
    <div class="max-w-4xl mx-auto py-6 font-jakarta">
        ...
        <form action="{{ route('categories.store') }}" method="POST" class="bg-white shadow-lg rounded-xl overflow-hidden">
            @csrf
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4"
                        class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition duration-200"
                        placeholder="Describe what kind of items belong to this category..." required></textarea>
                </div>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-end gap-3">
                ...
                <button type="submit"
                    class="px-4 py-2 text-sm font-medium text-white bg-green-600 rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 shadow-sm transition-colors">
                    Save Category
                </button>
            </div>
        </form>
